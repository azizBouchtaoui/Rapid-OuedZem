...
describe('phoneInputHelpers', function () {
  ...
  it('should trim the phone number if it exceeds the maximum length', function () {
    ...
    trimNumber('2135553535', 'US', metadata).should.equal('2135553535'); // National number. Exceeds the maximum length.

    trimNumber('21355535351', 'US', metadata).should.equal('2135553535'); // International number. Doesn't exceed the maximum length.
