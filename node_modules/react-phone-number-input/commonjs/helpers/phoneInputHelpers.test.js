...
describe('phoneInputHelpers', function () {
  ...
  it('should trim the phone number if it exceeds the maximum length', function () {
    ...
    (0, _phoneInputHelpers.trimNumber)('2135553535', 'US', _metadataMin["default"]).should.equal('2135553535'); // National number. Exceeds the maximum length.

    (0, _phoneInputHelpers.trimNumber)('21355535351', 'US', _metadataMin["default"]).should.equal('2135553535'); // International number. Doesn't exceed the maximum length.
