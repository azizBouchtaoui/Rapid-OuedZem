          ...
          <div className="section1__wrapper">
            ...
            <div className="section1__Container">
              <Link
                ...
                smooth={true}
                duration={1000}
                className="section1__Container-card"
              >
              ...
              >
                <div className="section1__Container-cardInfo">
                  ...
                  <p>
                    {" "}
                    Je veux en apprendre plus sur les conditions d'après-vente
                    et souhaite tout savoir sur les possibilités d'annulation et
                    d'échange que m'offre mon billet ?
                  </p>
